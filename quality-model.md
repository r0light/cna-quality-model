# A Quality Model for Cloud-native Software Architectures
...
* Confidentiality  
  ...
  * Data encryption in transit (Link, Endpoint)  
    ...
    * *Ratio of secured links* ([Zdun2023](https://doi.org/10.1145/3532183))
...
* Integrity  
  ...
  * Access restriction (Component, Endpoint)  
    ...
    * Access control management consistency (Component)  
      ...
      * *Ratio of endpoints that support token-based authentication * ([Ntentos2022](https://doi.org/10.1109/scc55611.2022.00029); [Zdun2023](https://doi.org/10.1145/3532183))
      ...
      * *Ratio of endpoints that support plaintext authentication* ([Ntentos2022](https://doi.org/10.1109/scc55611.2022.00029); [Zdun2023](https://doi.org/10.1145/3532183))
...
* Modularity  
  ...
  * Service-orientation (System, Service)  
    ...
    * Limited functional scope (Service, Endpoint)  
      ...
      * Limited endpoint scope (Service, Endpoint)  
        ...
        * *Number of provided synchronous and asynchronous endpoints* ([Apel2019](https://doi.org/10.1007%2F978-3-030-22482-0_15); [Engel2018](https://doi.org/10.1007%2F978-3-319-92901-9_8); [Shim2008](https://doi.org/10.1109/apsec.2008.32); [Brito2021](https://doi.org/10.1145/3412841.3442016); [Jin2021](https://doi.org/10.1109/tse.2019.2910531))
    ...
    * Separation by gateways (System, Component, Endpoint) +> Seamless upgrades  
      ...
      * *Centralization of externally available endpoints* ([Ntentos2020](https://doi.org/10.1007/978-3-030-65310-1_42))
      * *API Composition utilization metric* ([Ntentos2020](https://doi.org/10.1007/978-3-030-65310-1_42))
  ...
  * Loose coupling (System, Component, Link)  
    ...
    * Asynchronous communication (Link)  
      ...
      * *Number of asynchronous endpoints offered by a service* ([Shim2008](https://doi.org/10.1109/apsec.2008.32))
      * *Number of synchronous outgoing links* ([Apel2019](https://doi.org/10.1007%2F978-3-030-22482-0_15))
      * *Number of asynchronous outgoing links* ([Apel2019](https://doi.org/10.1007%2F978-3-030-22482-0_15))
...
* Analyzability  
  ...
  * Automated Monitoring (Service, Link, Infrastructure)  
    ...
    * Distributed tracing of invocations (Service, Link, Request Trace)  
      ...
      * *Distributed Tracing Support* ([Ntentos2020](https://doi.org/10.1007/978-3-030-65310-1_42))
...
* Modifiability  
  ...
  * Service independence (Service, Link)  
    ...
    * Low coupling (Service, Link)  
      ...
      * *Number of Consumed Endpoints* ([Apel2019](https://doi.org/10.1007%2F978-3-030-22482-0_15))
      ...
      * *Interaction density in the system* ([Tiwari2014](https://doi.org/10.1145/2659118.2659135))
      * *Interaction density of a system* ([Tiwari2014](https://doi.org/10.1145/2659118.2659135); [Karhikeyan2012](https://doi.org/10.1109/racss.2012.6212677))
      ...
      * *Number of Components that are linked to a component* ([Bogner2017](https://doi.org/10.1145/3143434.3143443); Rud2009; [Shim2008](https://doi.org/10.1109/apsec.2008.32); [Zhang2009](https://doi.org/10.1109/kam.2009.90))
      ...
      * *Aggregate System metric to measure service coupling* ([Hofmeister2008](https://doi.org/10.1109/edoc.2008.13))
    ...
    * Limited request trace scope (Request Trace)  
      ...
      * *Request Trace Length* ([Peng2022](https://doi.org/10.1145/3540250.3558951))
      * *Number of Cycles in Request Traces* ([Peng2022](https://doi.org/10.1145/3540250.3558951))
    ...
    * Backing service decentralization (Service, Backing Service)  
      ...
      * *Shared Storage Backing Service Interactions* ([Ntentos2020](https://doi.org/10.1007/978-3-030-65310-1_42); [Ntentos2020a](https://doi.org/10.1007%2F978-3-030-58923-3_1))
...
* Fault tolerance  
  ...
  * Persistent communication (Link)  
    ...
    * *Service Link Persistence utilization metric* ([Ntentos2020](https://doi.org/10.1007/978-3-030-65310-1_42))
    * *Outbox/Event Sourcing utilization metric* ([Ntentos2020](https://doi.org/10.1007/978-3-030-65310-1_42))
...
* Interoperability  
  ...
  * Consistently mediated communication (Component, Link) -> Time-behaviour +> Analyzability  
    ...
    * *Service Interaction via Central Component utilization metric* ([Ntentos2020](https://doi.org/10.1007/978-3-030-65310-1_42))
